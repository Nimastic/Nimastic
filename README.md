...
- **Responsibilities:**
  - Developed a front-end tool for creating and manipulating planograms used internally and on client dashboards.
  - Managed a team of 7 contract workers, improving AI data labeling accuracy by 400%.
  - Optimized data workflows for augmented reality applications.

### Software Engineer, Protechs Nutrition
- **Duration:** May 2024 - July 2024
- **Responsibilities:**
  - Led a team of 3 engineers in bi-weekly sprints to develop a fitness tracking app.
  - Implemented Firebase for user authentication and real-time data updates.
  - Delivered an app that achieved 95% uptime during user testing.

---

## 🛠️ Tools and Technologies
- **Languages:** TypeScript, Python, Java
- **Frameworks:** React Native, Vue.js, Flask
- **Others:** Firebase, AWS, PixiJS
